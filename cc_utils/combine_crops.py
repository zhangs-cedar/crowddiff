...
def get_arg_parser():
    ...
    # Datasets path
    parser.add_argument("--data_dir", default="", type=str, help="Path to the original dataset")
    parser.add_argument("--den_dir", default="", type=str, help="Path to the density results of cropped images")
    parser.add_argument("--output_dir", default="", type=str, help="Path to save the results")
