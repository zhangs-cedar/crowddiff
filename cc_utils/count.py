...
def get_arg_parser():
    ...
    # Dataset parameters
    parser.add_argument("--data_dir", default="./results", type=str, help="Path to the groundtruth density maps")
    parser.add_argument("--result_dir", default="", type=str, help="Path to the predicted density maps")

    # Output parameters
    parser.add_argument("--output_dir", default="", type=str, help="Path to the output of the code")

    # kernel parameters
    parser.add_argument("--thresh", default=200, type=int, help="Threshold value for the kernel")
