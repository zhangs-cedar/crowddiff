...
def create_q_samples(image, num_steps, maxvar, minvar):
    ...
    plt.axis("off")
    plt.savefig(f"experiments/final/q sample transparent/0.jpg", dpi=1200, format="jpg", bbox_inches="tight", pad_inches=0.0)
    ...
    for index, beta in enumerate(beta_schedule):
        ...
        plt.imshow(x_cur)
        plt.axis("off")
        plt.savefig(f"experiments/final/q sample transparent/{np.round(beta,2)}.jpg", dpi=1200, format="jpg", bbox_inches="tight", pad_inches=0.0)
...
def main(args):
    ...
    weather_index = {"clear": 0, "fog": 1, "rain": 2, "snow": 3}
    ...
    for device, img_list in enumerate(sub_list):
        for file in img_list:
            ...
            for _ in range(5):
                ...
                plt.axis("off")
                plt.savefig(f"experiments/final/q sample transparent/density{_}.jpg", dpi=1200, format="jpg", bbox_inches="tight", pad_inches=0.0)
